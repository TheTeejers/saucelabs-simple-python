...
# #
try:
    print (colored("looking for //iframe[@id='iframeResult']", 'green'))
    WebDriverWait(driver, 30).until(EC.presence_of_element_located((By.XPATH, "//iframe[@id='iframeResult']")))
    ...
    print(interact)
    driver.switchTo().frame(interact)
...
#
try:
    print (colored("looking for try it", 'green'))
    # WebDriverWait(driver, 30).until(EC.presence_of_element_located((By.ID, 'tryhome')))
    WebDriverWait(driver, 30).until(EC.presence_of_element_located((By.XPATH, "//*[text()='Try it']")))
    print (colored("found try it", 'green'))
    ...
    # print(interact)
    #
    # driver.switch_to().frame(interact);
    # sleep(5)
    print(colored("made it to here", 'red'))
    # interact = driver.find_elements_by_xpath("//*[contains(text(), 'Try it']")
    print("made it?")
    # interact = driver.find_elements_by_tag_name("button")
    # interact = driver.find_elements_by_xpath("//button")
    # interact = driver.find_element_by_css_selector("button")
    print("made it?")
    print("first         ")
    # print(interact)
    print(range(len(seq)))
    ...
    for index in range(len(seq)):
        ...
        try:
            print("in the TRY portion")

            WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.XPATH, "//button[text()='Try it']")))
            print('FOUND IT')
    ...
    # print("first         " + interact[0])
    # print("second        " + interact[1])
    # print(interact.get_attributes)
